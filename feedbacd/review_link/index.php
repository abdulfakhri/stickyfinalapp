...
require_once ('../includes/header.php');
	...
	$reviews = $dCtrl->index();
	$baseURL = "http://localhost:8080/stk_review/feedback/index.php?slug=";
?>
    <div class="container">
                            ...
                            foreach($reviews as $review) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button  id="<?php echo $review['rev_slug'];?>"  class="btn btn-success slug"> <i class="fa fa-code"></i></button>
